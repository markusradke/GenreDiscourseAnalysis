...
```{r mb 1015 contingency, fig.height=6, fig.width=10}
...
plot <- plot_dc_contingency(mb_10_15, poptrag)
ggplot2::ggsave(
...
```
:::{.column-page-inset-right}
```{r mb 2530 contingency,  fig.width=10, fig.height=8.6}
...
plot_dc_contingency(mb_25_30, poptrag)
```
:::
...
```
:::{.column-page-inset-right}
```{r s 1015 contingency, fig.height=6, fig.width=10}
...
plot_dc_contingency(s_10_15, poptrag, "Spotify")
```
:::
...
```
:::{.column-page-inset-right}
```{r s 2530 contingency, fig.width=10, fig.height=8.6}
...
plot_dc_contingency(s_25_30, poptrag, "Spotify")
```
:::
# Metagenre Examples
