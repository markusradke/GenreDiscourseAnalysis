...
# | fig-cap: "Contingency table of metagenre assignments between MusicBrainz and Discogs (first mentioned genre) for the 10-15 metagenre solution for external validation"
plot_dc_contingency(mb_low, poptrag)
```
:::
...
# | fig-cap: "Contingency table of metagenre assignments between MusicBrainz and Discogs (first mentioned genre) for the 25-30 metagenre solution for external validation"
plot <- plot_dc_contingency(mb_medium, poptrag)
ggplot2::ggsave(
...
# | fig-cap: "Contingency table of metagenre assignments between Spotify and Discogs (first mentioned genre) for the 10-15 metagenre solution for external validation"
plot_dc_contingency(s_low, poptrag, "Spotify")
```
:::
...
# | fig-cap: "Contingency table of metagenre assignments between Spotify and Discogs (first mentioned genre) for the 25-30 metagenre solution for external validation"
plot_dc_contingency(s_medium, poptrag, "Spotify")
```
:::
