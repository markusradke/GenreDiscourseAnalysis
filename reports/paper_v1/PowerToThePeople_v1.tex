...
\textit{tree depth}, \textit{feature fraction}). Here, we employed a coarse hyperparameter search with a 10-level initial grid and a maximum of 25 iterations for Bayesian optimization.
