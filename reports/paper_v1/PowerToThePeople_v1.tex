...
\begin{figure*}[htbp]
  ...
  \begin{subfigure}[b]{\columnwidth}
    ...
    \caption{COMGET-G5 and \textit{Essentia}-Predicted \textit{Rosamerica} Genres}
    \label{fig:rq3_rosa}
  \end{subfigure}
  \hfill
  \vspace{1.5 cm}
  \begin{subfigure}[b]{\columnwidth}
    ...
    \caption{COMGET-G12 and \textit{Discogs} Genres}
    \label{fig:rq3_dc}
  \end{subfigure}
  \caption{Contingency tables comparing COMGET  + FOLDCAT assignments to external genre assginments commonly used in MIR and cultural research; values show $P(\text{External} \mid \text{COMGET})$. Discarded external genres with less than 2\% relative freuqency for visualization (\textit{Rosamerica}: \textit{Speech}, \textit{Discogs}: \textit{Non-Music, Children's, Brass \& Military}).}
