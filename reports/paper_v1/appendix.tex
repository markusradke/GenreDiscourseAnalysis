...
\begin{tikzpicture}[
    ...
    \node[process, below=16mm of B] (E) {train final models on full data set with chosen hyperparameters};
    \node[terminator, below=10mm of C] (F) {evaluate final models on holdout set};
    \node[terminator, below=of F] (G) {model evaluation };
