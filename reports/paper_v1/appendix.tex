...
\newpage
\section{RQ3 outcomes for higher granularities}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dz_contingency.png}
    \caption{Contingency tables comparing COMGET-G25 to \textit{Deezer} assginments commonly used in MIR and cultural research; values show $P(\text{External} \mid \text{COMGET})$. Discarded external genres with less than 2\% relative freuqency for visualization: \textit{Disco, Soul \& Funk, Ranchera, Bolero, African Music, Turkish Music}).}
...
Please find further details and the complete code for reproduction hosted at \textit{Github}:
