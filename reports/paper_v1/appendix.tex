...
\begin{figure}[H]
    ...
    \caption{Contingency tables comparing COMGET-G25 to release genres from the \textit{Deezer} API; 26 genres were found in the data set; values show $P(\text{External} \mid \text{COMGET})$. Discarded genres for visualization with less than 2\% relative freuqency: \textit{Disco, Soul \& Funk, Ranchera, Bolero, African Music, Turkish Music}).}
